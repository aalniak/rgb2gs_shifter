...
entity my_latest_shifter_v1_0_S00_AXIS is
		generic (
...
end my_latest_shifter_v1_0_S00_AXIS;

architecture arch_imp of my_latest_shifter_v1_0_S00_AXIS is
	...
	type BYTE_FIFO_TYPE is array (0 to (NUMBER_OF_INPUT_WORDS-1)) of std_logic_vector(2 downto 0);
begin
	...
	-- FIFO Implementation
	 FIFO_GEN: for byte_index in 0 to (2) generate
